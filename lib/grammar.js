(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('Include'), o('While'), o('For'), o('Switch'), o('Class')],
    Block: [
    ...
    Comment: [
      ...
      }), o('CTORCOMMENT', function() {
        return new Comment($1, true);
      })
    ],
    Code: [
