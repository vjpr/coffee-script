(function() {
  ...
  exports.Code = Code = (function() {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (comments !== '') {
        if (!(this.getPreviousNodeIfComment(o) != null)) {
          code += "" + this.tab + "/**\n";
        }
        code += comments;
        code += "*/\n";
    ...
    Code.prototype.addFunctionComments = function(o) {
      var code, comment, extendsJsDoc, parentClassName, _ref2, _ref3;
      if (o.closure_nodoc) {
        return '';
      }
      code = '';
      ...
      if (this.isGoogleConstructor(o)) {
        ...
        comment = this.getPreviousNodeIfComment(o);
        if (!((comment != null) && (comment != null ? comment.search('@interface') : void 0) !== -1)) {
          code += "" + this.tab + "@constructor\n";
        }
        code += "" + extendsJsDoc + this.tab;
      }
      return code;
    };
    Code.prototype.getPreviousNodeIfComment = function(o) {
      ...
      return lastNode != null ? lastNode.comment : void 0;
    };
