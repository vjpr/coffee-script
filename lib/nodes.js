(function() {
  ...
  exports.Code = Code = (function() {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      idt = o.indent;
      code = '';
      code += this.openBlock(o);
      code += this.addFunctionComments(o);
    ...
    Code.prototype.openBlock = function(o) {
    ...
    Code.prototype.isPreviousNodeAComment = function(o) {
      var classBlock, lastNode, precedingComment, rootScope;
    ...
    Code.prototype.addParamAnnotations = function(o) {
      ...
      if (o.closure && o.closure_infer) {
        ...
        for (i = 0, _len = _ref2.length; i < _len; i++) {
          param = _ref2[i];
          tMode = false;
          if (((_ref3 = param.value) != null ? (_ref4 = _ref3.variable) != null ? (_ref5 = _ref4.base) != null ? _ref5.value : void 0 : void 0 : void 0) === 'T') {
