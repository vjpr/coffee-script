(function() {
  ...
  exports.Class = Class = (function() {
    ...
    function Class(variable, parent, body, comment) {
      this.variable = variable;
      this.parent = parent;
      this.body = body != null ? body : new Block;
      this.comment = comment != null ? comment : null;
      this.boundFuncs = [];
  ...
  exports.Code = Code = (function() {
    ...
    Code.prototype.compileNode = function(o) {
      var a, classBlock, code, defaultParam, exprs, extendsJsDoc, extendsNode, i, idt, isGoogleConstructor, lastNode, lit, namespaces, p, param, parentClassName, precedingComment, ref, rootScope, splats, types, v, val, vars, wasEmpty, _i, _j, _k, _len, _len2, _len3, _len4, _len5, _len6, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      idt = o.indent;
      isGoogleConstructor = (o.google || o.closure) && this.ctor;
      if (isGoogleConstructor) {
        if (this.ctorParent) {
          parentClassName = this.ctorParent.compile(o);
          if ((_ref6 = o.google) != null) {
            _ref6.includes.push({
        ...
        rootScope = o.scope.parent.expressions;
        classBlock = new Block(rootScope.expressions);
        console.log(this.ctor);
        console.log("--------------------------------------------------");
        lastNode = null;
        classBlock.contains(__bind(function(node) {
          if (node.ctor === this.ctor) {
            return true;
          }
          lastNode = node;
          return false;
        }, this));
        if ((lastNode != null ? lastNode.comment : void 0) != null) {
      ...
      if (o.closure && o.inferOptional) {
        code += '(';
        types = [];
        _ref8 = this.params;
        for (i = 0, _len5 = _ref8.length; i < _len5; i++) {
          param = _ref8[i];
          defaultParam = (_ref9 = param.value) != null ? (_ref10 = _ref9.base) != null ? _ref10.value : void 0 : void 0;
          types[i] = this.type(defaultParam);
        }
        for (i = 0, _len6 = vars.length; i < _len6; i++) {
          v = vars[i];
          a = types[i];
          if (v != null) {
            if (i > 0) {
